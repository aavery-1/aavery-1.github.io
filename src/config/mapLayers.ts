...
export const MAP_LAYERS: MapLayerDef[] = [
  ...
  {
    id: "existing_soh",
    label: "Existing Schools of Hope",
    group: "Schools",
    description: "Hope-operator sites that have drawn Revolving Loan Fund capital (F.S. 1001.292).",
  ...
  // ---- Boundaries ----
  {
    ...
    group: "Boundaries",
    description: "Individual school board member districts (District 1, 2, 3 ...).",
  ...
  },
  {
    ...
    group: "Context",
    description: "Isochrones showing the population reachable within a 15-minute drive.",
  ...
  },
  {
    ...
    group: "Context",
    description: "County-level population change, shaded light to dark (Census PEP).",
  ...
  },
  {
    ...
    group: "Context",
    description: "Tract median household income choropleth (ACS 5-year).",
